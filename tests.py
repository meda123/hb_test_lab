...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Context manager so we can access the session
    ...
    def test_games(self):
        """Make sure games appear on game page."""

        result = self.client.get("/games")
        # Our example game
        self.assertIn("Guess Who", result.data)
        self.assertIn("Really fun game where your guessing", result.data)
